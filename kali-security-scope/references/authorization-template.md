...
```yaml
engagement_id: <auto-generated normalized-target-UTCYYYYMMDD[-02] for Bug Bounty>
engagement_id_source: auto-generated | user-provided
...
rates:
  ...
  ports: top-1000
window:
  start: <user final confirmation time, ISO-8601 with timezone>
  end: until-complete-or-user-stop
mode: blackbox
```
